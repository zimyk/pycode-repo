class Restaurant():
	...
	def describe_restaurant(self):
		...
		print("They are known for their " + self.cuisine_type.title() + " Cuisine")
...
def main():
	...
	print("\n" + their_rest.restaurant_name.title() + " has the best local recipe")
	print("Their " + their_rest.cuisine_type.title() + " delicacies are unmatched")
